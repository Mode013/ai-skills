...
## 1.0.0-corp.1 — 2026-09-23

- Establish a corporate security policy for all skills.
- Default external network and production access to denied.
- Require offline architecture reports without JavaScript or CDN dependencies.
